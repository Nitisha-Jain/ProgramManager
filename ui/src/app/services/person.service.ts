        ...
        this.schedulerDataSource = new DataSource({
            store: new CustomStore({
                ...
                load: () => {
                    ...
                    const programData$ = this.httpClient.get('http://localhost:8080/api/v1/persondetails');
            ...
            insert: (values) => {
                ...
                return this.httpClient.post('http://localhost:8080/api/v1/persondetails', values).toPromise();
            },
            remove: (key) => {

                return this.httpClient.delete('http://localhost:8080/api/v1/persondetails/' + key.id).toPromise();
            },
            update: (values) => {
                delete values.settings;

                return this.httpClient.put('http://localhost:8080/api/v1/persondetails', values).toPromise();
            },
            }),
